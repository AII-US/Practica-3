...
from principal.models import Anime, Genero
...
class SpinboxListaGeneroForm(forms.Form):
    idUsuario = forms.CharField(label="Id de Usuario", widget=forms.TextInput, required=True)
    listaGeneros = forms.ModelChoiceField(label="Genero", widget=forms.Select, queryset=Genero.objects.all())